...
SELECT 'joao@gmail.com', 'Joao Maria', '$2a$10$ktLieeeNJAD9iA5l8VsR6..erCGtsqwWFm57vspe.wsxCT9FDTiXy', 'ROLE_PATIENT'
WHERE NOT EXISTS (SELECT 1 FROM usuario WHERE email = 'joao@gmail.com');
